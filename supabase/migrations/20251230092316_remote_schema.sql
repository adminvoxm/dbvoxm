drop policy "All Authenticated User Can Select" on "public"."status_generic";

alter table "public"."display_profiles" add column "all_entities" boolean;

alter table "public"."interaction" add column "redirect_link" text;

alter table "public"."interaction" add column "slug" text;

alter table "public"."point_of_distribution" add column "redirect_link" text;

alter table "public"."point_of_distribution" add column "slug" text;

alter table "public"."user_info" alter column "email" set not null;

CREATE UNIQUE INDEX interaction_redirect_link_key ON public.interaction USING btree (redirect_link);

CREATE UNIQUE INDEX interaction_slug_key ON public.interaction USING btree (slug);

CREATE UNIQUE INDEX point_of_distribution_redirect_link_key ON public.point_of_distribution USING btree (redirect_link);

CREATE UNIQUE INDEX point_of_distribution_slug_key ON public.point_of_distribution USING btree (slug);

alter table "public"."interaction" add constraint "interaction_redirect_link_key" UNIQUE using index "interaction_redirect_link_key";

alter table "public"."interaction" add constraint "interaction_slug_key" UNIQUE using index "interaction_slug_key";

alter table "public"."point_of_distribution" add constraint "point_of_distribution_redirect_link_key" UNIQUE using index "point_of_distribution_redirect_link_key";

alter table "public"."point_of_distribution" add constraint "point_of_distribution_slug_key" UNIQUE using index "point_of_distribution_slug_key";
...
;
  ...
  create policy "All Authenticated User Can Select"
  on "public"."status_generic"
  as permissive
  for select
